...
const Tags: NextPage<any> = (props: any) => {
    ...
    const searchTags = async (e: any) => {
        ...
        if(!key){
            ...
            await Axios.post(`${process.env.NEXT_PUBLIC_BLOG_URL}/tags/seek`, { key: key }, storage.getConfigWithBearer())
            .then((resp) => {
    ...
    const exportData = (e: any) => {
        ...
        if(blogContext.tags.length >= 0){

            const pdts = blogContext.tags.map((i) => {
    ...
    return (
        <Layout pageTitle='Tags' showBack={true} collapsed={false}>
                        ...
                        <div className='d-flex align-items-center'>
                            ...
                            <form className='card-search' onSubmit={(e) => { e.preventDefault(); }}>
                                <div className='card-input'>
                                    ...
                                    <Link onClick={(e) => { search.data.length > 0 ? clearSearch(e) : searchTags(e) }} href="" className='btn sm bgd-disable'>
                                        {
                                            ...
                                            <div className="ui-text-center">
                                                <div className="row">
                                                    <div className="col-md-10 mx-auto ui-text-center">
                                                        ...
                                                        <div className='font-frei onwhite fs-15 ui-line-height mrgt1 pdr1 pdl1'>We could not find tags from your request. Try again</div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <>
                                        <div className="ui-wrapper-small table-responsive">
                                            ...
                                            <table className="table ui-table">
                                                ...
                                                <thead>
                                                    <tr className='dark'>
                                                        ...
                                                        <th className="fs-13 font-freimedium">User</th>
                                                        ...
                                                        search.data.map((c, index) =>
                                                            <>
                                                                ...
                                                                <tr key={c._id} className="ui-table-row dark">
                                                                        ...
                                                                        <td className="fs-13 font-frei">{c.user && c.user._id === storage.getUserID() ? "You" : c.user ? c.user.firstName : 'User'}</td>
                                                                        <td className="fs-13">
                                            ...
                                            <div className='d-flex align-items-center mrgt2'>
                                                ...
                                                <p className='mrgb0'>
                                                    <span className='font-frei fs-14' style={{ color: "#585490" }}>Displaying { blogContext.count } tags out of { blogContext.total }</span>
                                                </p>
            ...
            <AddNew
                ...
                flattened={true}
                modalTitle={type === 'edit' ? 'Edit Tag' : 'Add Tag'}
                slim={'slim-lg'}
                data={data}
                type={type}
            />
...
Tags.getInitialProps = async (ctx: any) => {
